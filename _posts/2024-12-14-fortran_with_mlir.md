...
## コンパイラとIR
<details markdown="1"><summary>いろいろ書いたら長くなってしまったので折り畳み (クリックして表示)</summary>
...
<details markdown="1"><summary>(参考)Flangが生成するFIR (クリックして表示)</summary>
...
<details markdown="1"><summary>(参考)affine dialectを使った例 (クリックして表示)</summary>
